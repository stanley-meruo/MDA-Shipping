          ...
          >
            {vehicles.map((vehicle) => (
              <div
                ...
                className={`relative rounded-xl border-[0.3px] border-gray-100 shadow-md hover:bg-gray-100 hover:scale-95 cursor-pointer duration-300 transition-transform ${
