        ...
        <section className="grid md:flex md:items-center md:justify-between">
          <div className="w-full grid gap-5 px-5 xs:px-6 sm:px-10 md:pl-12 md:-mt-8 md:-mr-8 xmd:pl-14 xmd:-mt-24 xmd:-mr-16 lg:pl-16 xl:pl-22 xl:-mt-44 xl:-mr-36 xxl:pl-28">
            ...
            <Button
              ...
              className="bg-babyblue py-4 w-full text-sm text-white rounded-lg font-semibold font-inter hover:text-gray-700 hover:bg-gray-100 hover:scale-95 duration-300 transition-transform cursor-pointer sm:w-2/4 md:w-4/5 lg:w-4/6 lg:py-5 lg:mt-4"
            />
          </div>
      ...
      <section className="grid px-5 py-10 xs:px-6 sm:px-10 md:px-12 xmd:px-14 lg:px-16 xl:px-22 xxl:px-28">
        <section>
          <div className="grid gap-4 md:flex md:items-center">
            <h2 className="text-xl font-mulish font-bold text-babyblue md:w-2/4 md:-mr-6 xmd:-mr-20 lg:-mr-24 lg:text-2xl xl:-mr-48 xxl:-mr-[270px]">
              {vehicles.sectionTitle[0]}
            </h2>
            <div className="h-[2.5px] w-full bg-babyblue flex-grow"></div>
          </div>
          <div className="grid py-4 md:flex md:justify-between">
            <div className="my-4 font-inter w-full">
              <p className="text-sm md:w-72 xmd:w-80 lg:w-96 xl:w-[450px]">
          ...
          <div className="grid gap-4 mt-10 md:flex md:items-center">
            <h2 className="text-xl font-mulish font-bold text-babyblue md:w-2/4 md:-mr-16 xmd:-mr-28 lg:-mr-32 lg:text-2xl xl:-mr-56 xxl:-mr-[310px]">
          ...
          <div className="grid gap-4 mt-10 md:flex md:items-center">
            <h2 className="text-xl font-mulish font-bold text-babyblue md:w-2/4 md:-mr-26 xmd:-mr-36 lg:-mr-46 lg:text-2xl xl:-mr-68 xxl:-mr-[360px]">
          ...
          <div className="grid py-4 md:flex md:justify-between">
            ...
            <div className="w-full grid mt-2 md:mt-4">
              <img
