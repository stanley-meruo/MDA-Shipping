      ...
      <section className="grid px-5 py-10 xs:px-6 sm:px-10 md:px-12 xmd:px-14 lg:px-16 xl:px-22 xxl:px-28">
        ...
        <div className="py-4 md:flex md:justify-between">
          <div className="my-4 font-inter w-full">
            <p className="text-sm md:w-72 lg:w-96">
        ...
        <div className="grid gap-4 mt-16 md:flex md:items-center">
          <h2 className="text-xl font-mulish font-bold text-babyblue md:w-2/5 md:-mr-14 xmd:-mr-22 lg:-mr-24 lg:text-2xl xl:-mr-40">
...
export default MotorcycleLoading;